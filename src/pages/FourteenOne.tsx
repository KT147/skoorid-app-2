    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        <IonCard>
          <IonCardContent>
            <IonText>
              <span className="fourteen-one-center-info">
              <h2>{message}</h2>
              ...
              <IonCard className="fourteen-one-card">
                <IonCardContent>
                  <div className="fourteen-one-player-container">
                    <div
                    ...
                    >
                      ...
                      {starterFoulCount === 2 && (
                        <div>Vigu järjest: {starterFoulCount}</div>
                      )}
                      <br />
                      {starterIsActive === true && (
                        <div>
                          <IonButton
                            style={{ marginRight: "20px" }}
                            onClick={updateStarterScore}
                            disabled={
                              starterScore === Number(winnings) ||
                              opponentScore === Number(winnings)
                            }
                    ...
                    >
                      ...
                      {opponentFoulCount === 2 && (
                        <div>Vigu järjest: {opponentFoulCount}</div>
                      )}
                    </div>
                  </div>
                </IonCardContent>
